    ...
    <div className="flex flex-col gap-5">
      <div className="flex flex-col gap-5 sm:flex-row">
        ...
        <div className="">
          <h3>Bio:</h3>
          <p>
            {user?.bio || "This user didn't provided anything here :("}
          </p>
          <h3>Age:</h3>
          <p>
            {user?.age || "???"}
      ...
      <div>
        ...
        <div className="py-2 px-4 mb-4 bg-gray-100 rounded-xl">
          ...
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Modi quas rerum nisi nam quidem non harum voluptatem assumenda placeat aliquam!</p>
        </div>
        <div className="py-2 px-4 mb-4 bg-gray-100 rounded-xl">
          <h3 className="py-2 font-semibold">Im a post card (kinda)</h3>
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Modi quas rerum nisi nam quidem non harum voluptatem assumenda placeat aliquam!</p>
